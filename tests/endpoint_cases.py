...
SPECIAL_CALLS: dict[str, dict[str, Any]] = {
    ...
    "limit_up_public_report": {"date": "20260717", "security_code": "000001.SZ"},
    ...
    "supply_chain_company_supply_chain_companies": {"trade_code": "000001.SZ", "direction": "upstream", "page": 1, "page_size": 5},
